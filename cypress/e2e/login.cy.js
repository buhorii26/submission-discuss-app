...
describe('Login spec', () => {
  ...
  it('should display homepage when email and password are correct', () => {
    ...
    cy.get('h1').contains('Aplikasi Diskusi').should('be.visible');
    cy.get('p').contains('Sebuah aplikasi memudahkan pengguna untuk berdikusi sesuatu topik.').should('be.visible');
